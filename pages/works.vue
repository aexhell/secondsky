<template>
   <div id="__secondsky-content" class="md:w-1/2 px-8 pt-32 mb-48 h-full">
      ...
      <div class="__secondsky-works flex flex-col my-4">
         <a v-for="work of projs" :href="work.link" :class="`__secondsky-project-${work.code} w-full mb-${work.code !== 'mylium' ? '4' : '32'} no-underline bg-transculent border border-gray rounded-md`" v-bind:key="work.code">
